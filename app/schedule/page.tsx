...
<td className="border-r border-white/10 px-3 py-5 text-center">
  {isKnockoutRound ? (
<span className="relative -left-1 inline-flex h-8 min-w-[58px] items-center justify-center rounded-lg border border-white/20 bg-white/5 px-2 text-xs font-bold text-white">
      {matchOrder}
    </span>
  ) : (
    <span
...
<path
  ...
  />
      ...
      <div className="absolute left-[1000px] top-0 z-10 w-36">
        ...
        <div
          className="absolute -left-10 flex w-36 flex-col items-center"
          style={{
            top: `560px`,
          }}
        >
