...
<td className="border-r border-white/10 px-3 py-5 text-center">
  {isKnockoutRound ? (
<span className="relative -left-3 inline-flex h-8 min-w-[58px] items-center justify-center rounded-lg border border-white/20 bg-white/5 px-2 text-xs font-bold text-white">
      {matchOrder}
    </span>
  ) : (
    <span
