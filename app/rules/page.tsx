          ...
          <div className="bg-slate-950/75 border border-white/20 p-6 rounded-2xl shadow-md">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-3 text-xs text-slate-300">
              <div className="bg-black/30 border border-white/5 p-3 rounded-lg">
                ...
                <p className="text-slate-400 leading-relaxed">ยึดตามมาตรฐานสากล <span className="text-emerald-400 font-medium">"สามารถเสิร์ฟลูกยิง หรือลูก Backhand สูงพุ่งไปด้านหลัง"</span> ได้</p>
              </div>
