            ...
            <div className="relative w-full py-3.5 px-4 md:px-8 flex flex-row justify-between items-center select-none flex-shrink-0 z-20 gap-4">
              ...
              <div className="flex items-center gap-6 relative z-20">
                ...
                <img
                  ...
                  className="h-7 md:h-8 w-auto object-contain drop-shadow-[0_0_10px_rgba(255,255,255,0.2)]"
                  alt="Sandisk"
                />
                ...
                <img
                  src="/Sponsor.png"
                  className="h-10 w-auto object-contain drop-shadow-[0_0_10px_rgba(255,255,255,0.2)]"
                  alt="Sponsor"
                />
